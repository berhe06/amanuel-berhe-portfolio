...
const projects = [
  {
    title: "DinnerWhere",
    problem: "Choosing where to eat frustrates groups — everyone defaults to the same places or decision paralysis sets in.",
    solution: "Built a swipe-based restaurant discovery app for groups using React Native and Firebase, letting everyone vote simultaneously.",
    impact: ["70+ daily users at launch", "Live in 4 cities", "Increased group decision speed"],
    ...
    cta: { label: "Download on App Store", href: "https://apps.apple.com/us/app/dinnerwhere/id6760210873", apple: true },
  },
  {
    ...
    cta: { label: "View Patent", href: "https://patentimages.storage.googleapis.com/1b/65/47/20b79470a64d15/US20230025926A1.pdf" },
  },
  {
  ...
  },
  {
    ...
    cta: { label: "Read Publication", href: "https://www.sciencedirect.com/science/article/pii/S235218721830010X" },
  },
];
                ...
                {"cta" in p && p.cta && (
                  <div style={{ marginTop: 20 }}>
                    <a
                      ...
                      className="inline-flex items-center no-underline transition-all duration-200"
                      style={{
                        fontFamily: "Inter, sans-serif",
                        fontSize: 13,
                        fontWeight: 600,
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.backgroundColor = "rgba(79,156,249,0.18)";
                        e.currentTarget.style.borderColor = "rgba(79,156,249,0.5)";
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.backgroundColor = "rgba(79,156,249,0.1)";
                        e.currentTarget.style.borderColor = "rgba(79,156,249,0.25)";
                      }}
                    >
                      {p.cta.apple && <span style={{ fontSize: 14, lineHeight: 1 }}></span>}
                      {p.cta.label}
                      {!p.cta.apple && <span style={{ fontSize: 11, opacity: 0.7 }}>↗</span>}
                    </a>
                  </div>
                )}
              </div>
